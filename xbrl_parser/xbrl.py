...
class XBRLParser(object):
    ...
    def parseGAAP(self,
        ...
        current_liabilities = \
            xbrl.find_all(name=re.compile("(us-gaap:)[^s]*(currentliabilities)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        noncurrent_liabilities = \
            xbrl.find_all(name=re.compile("(us-gaap:)[^s]*(noncurrentliabilities)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        commitments_and_contingencies = \
            xbrl.find_all(name=re.compile("(us-gaap:commitmentsandcontingencies)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        equity_attributable_interest = \
            xbrl.find_all(name=re.compile("(us-gaap:minorityinterest)",
                          re.IGNORECASE | re.MULTILINE))
        equity_attributable_interest += \
            xbrl.find_all(name=re.compile("(us-gaap:partnerscapitalattributabletononcontrollinginterest)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        equity_attributable_parent = \
            xbrl.find_all(name=re.compile("(us-gaap:liabilitiesandpartnerscapital)",
                          re.IGNORECASE | re.MULTILINE))
        stockholders_equity = \
        ...
        cost_of_revenue += \
            xbrl.find_all(name=re.compile("(us-gaap:costofgoodssold)",
                          re.IGNORECASE | re.MULTILINE))
        cost_of_revenue += \
            xbrl.find_all(name=re.compile("(us-gaap:costofgoodsandservicessold)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        operating_income_loss = \
            xbrl.find_all(name=re.compile("(us-gaap:operatingIncomeLoss)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        income_before_equity_investments = \
            xbrl.find_all(name=re.compile("(us-gaap:incomelossfromcontinuingoperationsbeforeincometaxesminorityinterest)",
                          re.IGNORECASE  | re.MULTILINE))
        ...
        income_from_equity_investments = \
            xbrl.find_all(name=re.compile("(us-gaap:incomelossfromequitymethodinvestments)", re.IGNORECASE | re.MULTILINE))
        ...
        income_continuing_operations_tax = \
            xbrl.find_all(name=re.compile("(us-gaap:IncomeLossBeforeExtraordinaryItemsAndCumulativeEffectOfChangeInAccountingPrinciple)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        income_discontinued_operations = \
            xbrl.find_all(name=re.compile("(us-gaap:)[^s]*(discontinuedoperation)", re.IGNORECASE | re.MULTILINE))
        ...
        extraordary_items_gain_loss = \
            xbrl.find_all(name=re.compile("(us-gaap:extraordinaryitemnetoftax)", re.IGNORECASE | re.MULTILINE))
        ...
        net_income_shareholders = \
            xbrl.find_all(name=re.compile("(us-gaap:netincomeavailabletocommonstockholdersbasic)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        preferred_stock_dividends = \
            xbrl.find_all(name=re.compile("(us-gaap:preferredstockdividendsandotheradjustments)", re.IGNORECASE | re.MULTILINE))
        gaap_obj.preferred_stock_dividends = \
            self.data_processing(preferred_stock_dividends, xbrl,
                ignore_errors, logger, context_ids)

        net_income_loss_noncontrolling = \
            xbrl.find_all(name=re.compile("(us-gaap:netincomelossattributabletononcontrollinginterest)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        other_comprehensive_income = \
            xbrl.find_all(name=re.compile("(us-gaap:othercomprehensiveincomelossnetoftax)", re.IGNORECASE | re.MULTILINE))
        ...
        comprehensive_income_parent = \
            xbrl.find_all(name=re.compile("(us-gaap:comprehensiveincomenetoftax)", re.IGNORECASE | re.MULTILINE))
        gaap_obj.comprehensive_income_parent = \
            self.data_processing(comprehensive_income_parent, xbrl,
                                 ignore_errors, logger, context_ids)

        comprehensive_income_interest = \
            xbrl.find_all(name=re.compile("(us-gaap:comprehensiveincomenetoftaxattributabletononcontrollinginterest)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_operating = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedinoperatingactivities)", re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_investing = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedininvestingactivities)", re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_financing = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedinfinancingactivities)", re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_operating_continuing = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedinoperatingactivitiescontinuingoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_investing_continuing = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedininvestingactivitiescontinuingoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_financing_continuing = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedinfinancingactivitiescontinuingoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_operating_discontinued = \
            xbrl.find_all(name=re.compile("(us-gaap:cashprovidedbyusedinoperatingactivitiesdiscontinuedoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_investing_discontinued = \
            xbrl.find_all(name=re.compile("(us-gaap:cashprovidedbyusedininvestingactivitiesdiscontinuedoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        net_cash_flows_discontinued = \
            xbrl.find_all(name=re.compile("(us-gaap:netcashprovidedbyusedindiscontinuedoperations)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        common_shares_outstanding = \
            xbrl.find_all(name=re.compile("(us-gaap:commonstocksharesoutstanding)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        common_shares_issued = \
            xbrl.find_all(name=re.compile("(us-gaap:commonstocksharesissued)",
                          re.IGNORECASE | re.MULTILINE))
        ...
        common_shares_authorized = \
            xbrl.find_all(name=re.compile("(us-gaap:commonstocksharesauthorized)",
                          re.IGNORECASE | re.MULTILINE))
